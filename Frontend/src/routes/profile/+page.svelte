...
<div class="text-center w-100 h-100 position-relative d-flex align-items-center">
	<div class="w-100">
		<h1 style="text-align:center;color: black">
			Profile
			<i on:click={toogle_editMode} class="fa fa-edit" style="cursor: pointer;font-size: 1.5rem;" ></i>
		</h1>
		{#if user}
			<div class="user-picture my-3">
				<img src="/user.png" alt="user" style="width:200px;height:200px;" />
			</div>
			...
			<button class="btn btn-danger my-5" on:click={deleteAccount}>Delete Account</button>
		{:else}
			<h1>Loading...</h1>
		{/if}
	</div>
	<button class="btn position-absolute top-0 start-0 p-4" on:click={backButton}>
