...
<PhoneAppLayout {title}>
  <section class="text-center text-lg-start">
      ...
      <div class="row g-0 align-items-center justify-content-center" >
        ...
        <div class="card cascading-right border-0">
                ...
                <div class="tab-pane show active" id="pills-login" role="tabpanel" aria-labelledby="pills-login">
                  <form>
                    ...
                    <div class="text-center">
                      <p>Not a member? <a href="#pills-register" data-bs-target="#pills-register" id="registerBtn">Register</a></p>
                    </div>
                  </form>
                </div>
                <div class="tab-pane" id="pills-register" role="tabpanel" aria-labelledby="tab-register">
                  <form>
                    ...
                    <div class="form-check d-flex justify-content-center mb-4">
                      <input id="formSignupCheck" class="form-check-input me-2" type="checkbox" value="" checked aria-describedby="registerCheckHelpText">
